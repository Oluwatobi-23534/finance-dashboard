...
import { Area, Legend, AreaChart, CartesianGrid, Line, ResponsiveContainer, Tooltip, XAxis, YAxis, LineChart, BarChart, Bar, Rectangle } from 'recharts'
  ...
  return (
    <>
      <DashboardBox gridArea="a">
        <BoxHeader title='Revenue and Expenses' sideText='+4%' subtitle='top line represents revenue, bottom line represents expenses' />
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis tickLine={false} dataKey="name" style={{ fontSize: "10px" }} />
      ...
      <DashboardBox gridArea="b">
        <BoxHeader title='Profit and Revenue' sideText='+4%' subtitle='top line represents revenue, bottom line represents expenses' />
        <ResponsiveContainer width="100%" height="100%">
          <LineChart
            width={500}
            height={400}
      ...
      <DashboardBox gridArea="c">
        <BoxHeader title='Revenue Month by month' sideText='+4%' subtitle='graph representing the menu month by month' />
        <ResponsiveContainer width="100%" height="100%">
          <BarChart
            width={500}
            height={300}
